...
import entities.VideoLesson;

public class Integracao {

    public static void main(String[] args) {
        String[] videos = { "4668c219-296d-40de-a073-99b85026e977,01-01 Visão geral do capítulo.mp4,222",
    ...
    public static String csvToJson(String[] videos) {
        ...
        for (String v : videos) {
            ...
            //Split usando o separador vírgula
            String[] data = v.split(",");
            VideoLesson lesson = new VideoLesson(data[0], data[1], data[2]);

            //Adiciona o objeto lesson serializado na List
            videoList.add(lesson.toJsoString());
            
        }

        String json = "["
            + String.join(",", videoList)
            + "\n]";
